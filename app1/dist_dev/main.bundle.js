...
var Coracao = /** @class */ (function () {
    function Coracao(cheio, urlCoracaoCheio, urelCoracaoVazio) {
        if (urlCoracaoCheio === void 0) { urlCoracaoCheio = "/assets/coracao_cheio.png"; }
        if (urelCoracaoVazio === void 0) { urelCoracaoVazio = "/assets/coracao_vazio.png"; }
        this.cheio = cheio;
        this.urlCoracaoCheio = urlCoracaoCheio;
        this.urelCoracaoVazio = urelCoracaoVazio;
    }
...
var TentativasComponent = /** @class */ (function () {
    function TentativasComponent() {
        this.coracoes = [
            new __WEBPACK_IMPORTED_MODULE_1__shared_coracao_model__["a" /* Coracao */](true), new __WEBPACK_IMPORTED_MODULE_1__shared_coracao_model__["a" /* Coracao */](true), new __WEBPACK_IMPORTED_MODULE_1__shared_coracao_model__["a" /* Coracao */](true) //Instancia um array de corações cheios
        ];
        console.log(this.coracoes);
    }
    TentativasComponent.prototype.ngOnChanges = function () {
        if (this.tentativas !== this.coracoes.length) {
            var indice = this.coracoes.length - this.tentativas; //esse trecho controla as tentativas 
